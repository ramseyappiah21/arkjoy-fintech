      ...
      <section className="border-b border-forest/10 bg-paper">
        <div className="mx-auto grid max-w-7xl gap-0 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-center bg-gold px-6 py-10 text-ink sm:px-10 sm:py-12">
            ...
            <Link
              href="/personal#loans"
              className="mt-8 inline-flex w-full items-center justify-center rounded-full bg-ink px-5 py-3.5 text-sm font-semibold text-gold transition hover:bg-forest hover:text-paper sm:w-fit"
            >
              Get a Loan
            </Link>
          </div>
